...
users:
  - name: airgon
    ...
    ssh_authorized_keys:
      - ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAINszckLSAJBL2aZcsaTfkWZ7Z2KMsMQtSUu25DVsr/Ta ggonzalezdal@uoc.edu
...
The password hash used in this lab is suitable for testing, but a unique value should be generated for a real production environment.
