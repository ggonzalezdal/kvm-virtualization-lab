...
-   ✅ SSH restricted to `eth1` and `10.10.10.0/24`
-   ✅ DHCP allowed on trusted LAN interface
-   ✅ DNS UDP and TCP restricted to trusted LAN
-   ✅ ICMP Echo Request restricted to trusted LAN
-   ✅ LAN-to-WAN NEW forwarding explicitly permitted
-   ✅ RELATED/ESTABLISHED return traffic explicitly permitted
-   ✅ Unsolicited upstream-to-LAN NEW traffic blocked
...
-   ✅ `rp_filter` vs `iptables` behavior investigated
-   ✅ NAT/MASQUERADE and conntrack behavior verified
-   ✅ Firewall rules persisted with OpenRC
-   ✅ Router, services, NAT and logging verified after reboot
-   ✅ Alpine-Lab-02 end-to-end connectivity verified
...
The next project step is to document, commit, push, and snapshot this
known-good Phase 5 state before beginning Phase 6.
